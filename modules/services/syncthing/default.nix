...
in {
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.syncthing.serviceConfig.ExecStartPost = mkIf (cfg.gui.enable && cfg.gui.hashed-admin-password-file != null) (pkgs.writeShellScriptBin "inject-syncthing-gui-password" ''
