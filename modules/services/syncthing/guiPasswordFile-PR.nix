# This file is a copy of the changed syncthing module propsed in https://github.com/NixOS/nixpkgs/pull/290485. We import this custom module because the PR hasn't yet been merged into nixpkgs.

# When the PR merges and we update our nixpkgs we can remove this.
{
  config,
  lib,
  options,
